...
A group of students tried to develop a Recipe Cook book in  2009 with the latest technology at its time. 

They called it: Awesome Recipe Cookbook. 
...
# What they managed to create
 ...
 - an SQLite database (containing recipes)
...
```bash
$ sudo ps aux | grep "recipe-cookbook"
```
