...
<div>
    <img src="./assets_cloud_and_azure/wm-ita.png" alt="Port 22 ssh inbound rule allow"/>
</div>
...
```
Or, in case of missing private key info:

```
$ ssh -i /path/to/your/private/id_rsa  azureuser@<ip-address> 
```

In case of permission issues:

```bash
$ chmod 600 /path/to/your/private/id_rsa
```
...
When you provision a new server you should upgrade it. Here is how: 
